...
export const getRunsFailure = (state = INITIAL_STATE) => {
  return {
    ...state,
    isLoading: false
  }
...
export const createRunFailure = (state = INITIAL_STATE) => {
  return {
    ...state,
    isSaving: false,
    saved: false
...
export const createRunReset = (state = INITIAL_STATE) => {
  return {
    ...state,
    isSaving: false,
    saved: false
...
export const removeRunRequest = (state = INITIAL_STATE) => {
  return {
    ...state,
    isSaving: true
  }
...
export const removeRunFailure = (state = INITIAL_STATE) => {
  return {
    ...state,
    isSaving: false
  }
